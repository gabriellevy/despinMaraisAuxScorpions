from abs.lancerDe import LancerDe
...
def GenererNumeros41_50(genHist):
    ...
    effet44 = genHist.AjouterEffet("""
        ...
        direction du nord ou du sud.
        """, "44")
    genHist.AjouterChoixGoToEffet(" Si vous souhaitez aller au nord", goToEffetId="157")
